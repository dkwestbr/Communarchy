...
public class GetRecentArguments implements IPagedQuery<Argument> {

	@SuppressWarnings("unused")
	private GetRecentArguments() {}
	...
	public GetRecentArguments(String startCursor) {
		this.startCursor = startCursor;
		
		this.memcacheKey = String.format("%s_%s", GetRecentArguments.class.getName(), startCursor);
